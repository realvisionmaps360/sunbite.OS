...
export const STRINGS: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    "operation.close": "Encerrar o dia",
    ...
    "checklist.nextPhase": "Ir para {phase}",
    "checklist.nextPhaseAnyway": "Ir para {phase} mesmo assim",
    ...
    "close.tipsCash": "Gorjetas em dinheiro",
    ...
    "close.confirm": "Confirmar encerramento",
    "close.breakdown": "Início {initial} + vendas em dinheiro {sales}",
    "close.adjustments": "± lançamentos {value}",
    // Trava do dinheiro (ops 24, decisao do Felipe em 22/09): sem contagem
    // nao ha encerramento. Vale so no fechamento — o caminho da venda
    // continua sem confirmacao nenhuma.
    "close.countedRequired": "Conte o dinheiro da caixa para poder encerrar.",
    "close.neverOpened":
      "Este dia nunca foi aberto no sistema, então não há caixa inicial registrado. Dá para encerrar assim mesmo — fica guardado como ocorrência.",
    "close.noOpeningPendency": "Dia encerrado sem abertura formal — caixa inicial não registrado.",

    // O resumo do dia (ops 24). Antes o encerramento nao respondia nada: a
    // operacao fechada sumia da tela e sobrava "Nenhuma operacao em
    // andamento", que parece que o toque nao funcionou.
    "summary.title": "Dia encerrado",
    "summary.period": "{start} → {end}",
    "summary.duration": "Duração",
    "summary.place": "Local",
    "summary.event": "Evento",
    "summary.revenue": "Total vendido",
    "summary.cups": "Copos",
    "summary.sales": "Vendas",
    "summary.cash": "Dinheiro",
    "summary.twint": "TWINT",
    "summary.tips": "Gorjetas",
    "summary.pace": "Ritmo",
    "summary.paceValue": "{n} copos/hora",
    "summary.paceEstimated": "estimado pela hora da primeira venda",
    "summary.reason": "Motivo da diferença",
    "summary.noOpening": "Este dia não teve abertura registrada.",
    "summary.orphanSales_one": "1 venda deste dia não está amarrada à operação.",
    "summary.orphanSales": "{n} vendas deste dia não estão amarradas à operação.",
    "summary.dayTitle": "Dia {date}",
    "summary.endEstimated": "fim estimado pela hora da última venda",
    "summary.noOperation": "Não houve operação registrada neste dia — por isso não há local, horário de abertura nem caixa.",
    "summary.localOnly": "Sem internet ou sem login: estes números são só deste aparelho.",
    "sales.daysLocalOnly": "Sem internet ou sem login: mostrando só os dias deste aparelho.",
    "sales.dayLoading": "Carregando…",
    "sales.daySummary": "Ver resumo",
    "summary.offline": "Sem internet agora — estes números podem estar incompletos.",
    "summary.close": "Fechar",
    "summary.closedAt": "Operação de hoje encerrada às {time}.",
    "summary.view": "Ver resumo",
  ...
  de: {
    ...
    "review.tip": "Trinkgeld",
    "review.tipNone": "kein Trinkgeld",
    ...
    "operation.close": "Tag abschliessen",
    ...
    "checklist.nextPhase": "Weiter zu {phase}",
    "checklist.nextPhaseAnyway": "Trotzdem zu {phase}",
    ...
    "close.countedRequired": "Bargeld zählen, um abschliessen zu können.",
    "close.neverOpened":
      "Dieser Tag wurde nie eröffnet, es gibt also keinen Anfangs­bestand. Abschliessen geht trotzdem — es wird als Vorfall festgehalten.",
    "close.noOpeningPendency": "Tag ohne Eröffnung abgeschlossen — kein Anfangs­bestand erfasst.",

    "summary.title": "Tag abgeschlossen",
    "summary.period": "{start} → {end}",
    "summary.duration": "Dauer",
    "summary.place": "Ort",
    "summary.event": "Termin",
    "summary.revenue": "Umsatz",
    "summary.cups": "Becher",
    "summary.sales": "Verkäufe",
    "summary.cash": "Bargeld",
    "summary.twint": "TWINT",
    "summary.tips": "Trinkgeld",
    "summary.pace": "Tempo",
    "summary.paceValue": "{n} Becher/Std.",
    "summary.paceEstimated": "geschätzt ab dem ersten Verkauf",
    "summary.reason": "Grund der Differenz",
    "summary.noOpening": "Für diesen Tag wurde keine Eröffnung erfasst.",
    "summary.orphanSales_one": "1 Verkauf dieses Tages ist keinem Betrieb zugeordnet.",
    "summary.orphanSales": "{n} Verkäufe dieses Tages sind keinem Betrieb zugeordnet.",
    "summary.dayTitle": "Tag {date}",
    "summary.endEstimated": "Ende geschätzt ab dem letzten Verkauf",
    "summary.noOperation": "Für diesen Tag wurde kein Betrieb erfasst — deshalb gibt es keinen Ort, keine Eröffnung und keine Kasse.",
    "summary.localOnly": "Kein Internet oder nicht angemeldet: diese Zahlen stammen nur von diesem Gerät.",
    "sales.daysLocalOnly": "Kein Internet oder nicht angemeldet: nur die Tage dieses Geräts.",
    "sales.dayLoading": "Lade…",
    "sales.daySummary": "Übersicht",
    "summary.offline": "Kein Internet — diese Zahlen können unvollständig sein.",
    "summary.close": "Schliessen",
    "summary.closedAt": "Heutiger Betrieb um {time} abgeschlossen.",
    "summary.view": "Übersicht ansehen",
